...
public class Systeme {
	 ...
	 * 
	 * \//!\\//!\\//!\\\//!\\//!\\//!\\\//!\\//!\\//!\\\//!\\//!\\//!\\
	 * La recherche ne respecte pas strictement le diagramme de séquence
	 * car l'implémentation stricte du diagramme auait entrainé un code
	 * beaucoup plus complexe et difficile à maintenir
	 * \//!\\//!\\//!\\\//!\\//!\\//!\\\//!\\//!\\//!\\\//!\\//!\\//!\\
	 * 
	...
	/**
	 * Récupère l'Oeuvre située à l'index i
	 * 
	 * @param i : index de l'oeuvre à retourner
