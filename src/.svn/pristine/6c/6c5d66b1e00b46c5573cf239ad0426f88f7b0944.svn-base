...
/**
 * Représente un utilisateur quelconque (historien ou photographe)
 * Permet de regrouper tous les utilisateurs dans une même liste
...
public class Utilisateur {
	...
	/**
	 * Crée un nouvel utilisateur ayant pour identifiant <login>
	 ...
	 * 
	 * @param aLogin : le login à comparer
	 * @param aPassword : le mot de passe à comprarer
	 * 
